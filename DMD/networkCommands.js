define([], function()
{
	...
	network.setupSocketUpdate = function(data)
	{
	...
	network.continueGame = function(data)
	{
	...
	network.startGame = function(data)
	{
	...
	network.endLocalGame = function(data)
	{
		window.inGame = false;
